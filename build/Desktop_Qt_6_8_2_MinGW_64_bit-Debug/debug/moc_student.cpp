...
static constexpr auto qt_meta_stringdata_ZN7StudentE = QtMocHelpers::stringData(
    "Student",
    "on_pushButton_clicked",
    "",
    "on_pushButton_4_clicked",
    "on_changePassword_clicked",
    "on_prevResult_clicked"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
#endif // !QT_MOC_HAS_STRINGDATA

Q_CONSTINIT static const uint qt_meta_data_ZN7StudentE[] = {
...
Q_CONSTINIT const QMetaObject Student::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7StudentE.offsetsAndSizes,
    qt_meta_data_ZN7StudentE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7StudentE_t,
        // Q_OBJECT / Q_GADGET
...
void Student::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_changePassword_clicked(); break;
        case 3: _t->on_prevResult_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *Student::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7StudentE.stringdata0))
