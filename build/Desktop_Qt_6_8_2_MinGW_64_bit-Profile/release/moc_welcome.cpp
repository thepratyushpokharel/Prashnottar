...
static constexpr auto qt_meta_stringdata_ZN7WelcomeE = QtMocHelpers::stringData(
    "Welcome",
    "on_pushGo_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7WelcomeE[] = {
...
Q_CONSTINIT const QMetaObject Welcome::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7WelcomeE.offsetsAndSizes,
    qt_meta_data_ZN7WelcomeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7WelcomeE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Welcome, std::true_type>,
        // method 'on_pushGo_clicked'
...
void Welcome::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_pushGo_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *Welcome::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7WelcomeE.stringdata0))
