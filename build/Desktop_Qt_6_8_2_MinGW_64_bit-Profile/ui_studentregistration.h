...
"background-color: rgb(167, 171, 170);"));
        ...
        logo2 = new QLabel(studentRegistration);
        logo2->setObjectName("logo2");
        logo2->setStyleSheet(QString::fromUtf8(""));

        horizontalLayout_9->addWidget(logo2);
...
"margin-right:200px;"));
    ...
    void retranslateUi(QDialog *studentRegistration)
    {
        ...
        logo2->setText(QCoreApplication::translate("studentRegistration", "TextLabel", nullptr));
