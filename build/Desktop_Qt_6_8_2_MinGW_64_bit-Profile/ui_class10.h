...
public:
    ...
    void setupUi(QDialog *class10)
    {
        ...
        class10->resize(1100, 698);
        class10->setStyleSheet(QString::fromUtf8("QComboBox\n"
"{\n"
"border: 1px solid;\n"
"border-radius: 12px; \n"
...
"	width:500px;\n"
"}"));
        gridLayout_2 = new QGridLayout(class10);
        gridLayout_2->setObjectName("gridLayout_2");
        groupBox = new QGroupBox(class10);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1052, 404));
    ...
    void retranslateUi(QDialog *class10)
    {
        ...
        start->setText(QCoreApplication::translate("class10", "Go", nullptr));
        prevButton->setText(QCoreApplication::translate("class10", "Previous", nullptr));
        nextButton->setText(QCoreApplication::translate("class10", "Next", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("class10", "GroupBox", nullptr));
        questionLabel->setText(QCoreApplication::translate("class10", "Text", nullptr));
        option1->setText(QCoreApplication::translate("class10", "option1", nullptr));
        option2->setText(QCoreApplication::translate("class10", "option2", nullptr));
        option3->setText(QCoreApplication::translate("class10", "option3", nullptr));
        option4->setText(QCoreApplication::translate("class10", "option4", nullptr));
        homeButton->setText(QCoreApplication::translate("class10", "Return Home", nullptr));
        label->setText(QCoreApplication::translate("class10", "*Read the instructions below carefully:\n"
...
"2.After you choose subject and click 'Go' Your timer will be started.", nullptr));
        logo5->setText(QCoreApplication::translate("class10", "TextLabel", nullptr));
        label_2->setText(QCoreApplication::translate("class10", "Examination Class 10", nullptr));
